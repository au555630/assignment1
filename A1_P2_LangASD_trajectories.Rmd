...
#gender
gender= glm(Gender ~ Diagnosis, family="binomial", visit_1) #use binomial if only two
summary(gender)
#no significant difference
...
ggplot(visit_1, aes(Diagnosis, CHI_MLU)) + geom_boxplot()
ggplot(visit_6, aes(Diagnosis, CHI_MLU)) + geom_boxplot()
